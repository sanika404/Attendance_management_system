...
def change_pass():
    ...
    master.configure(background="#282a36")  # Dark grey
    lbl4 = tk.Label(master,text='    Enter Old Password',bg='#282a36',fg='white',font=('comic', 12, ' bold '))
    lbl4.place(x=10,y=10)
    global old
    old=tk.Entry(master,width=25 ,fg="white",bg="#44475a",relief='solid',font=('comic', 12, ' bold '),show='*')  # Lighter grey
    old.place(x=180,y=10)
    lbl5 = tk.Label(master, text='   Enter New Password', bg='#282a36', fg='white', font=('comic', 12, ' bold '))
    lbl5.place(x=10, y=45)
    global new
    new = tk.Entry(master, width=25, fg="white",bg="#44475a",relief='solid', font=('comic', 12, ' bold '),show='*')
    new.place(x=180, y=45)
    lbl6 = tk.Label(master, text='Confirm New Password', bg='#282a36', fg='white', font=('comic', 12, ' bold '))
    lbl6.place(x=10, y=80)
    global nnew
    nnew = tk.Entry(master, width=25, fg="white",bg="#44475a", relief='solid',font=('comic', 12, ' bold '),show='*')
    nnew.place(x=180, y=80)
    cancel=tk.Button(master,text="Cancel", command=master.destroy ,fg="white"  ,bg="#ff5555" ,height=1,width=25 , activebackground = "#ff6e67" ,font=('comic', 10, ' bold '))  # Red
    cancel.place(x=200, y=120)
    save1 = tk.Button(master, text="Save", command=save_pass, fg="white", bg="#50fa7b", height = 1,width=25, activebackground="#5af78e", font=('comic', 10, ' bold '))  # Green
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="#ff61e5",bg="#1a1a1a" ,width=55 ,height=1,font=('comic', 22, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="#ff61e5",bg="#1a1a1a" ,width=55 ,height=1,font=('comic', 22, ' bold '))
